...
/*
* / Create new PluginFile, name it lang.yml, use defaults lang.yml
*PluginFile lang = new PluginFile("lang.yml", "lang.yml");
*String message = lang.get("message");
*
* /Create new PluginFile, name it names.yml
*PluginFile names = new PluginFile("names.yml");
*names.set("name", "Logout400");
*names.save();
* */
